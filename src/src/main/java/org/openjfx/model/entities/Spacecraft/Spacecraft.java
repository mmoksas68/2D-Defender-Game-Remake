...
public class Spacecraft extends LocatableObject implements FireBullets {
    ...
    public Bullet fireBullet() {
        ...
        return new Bullet(location,(Bullet.WIDTH_SCALE * BossMap.getHitboxHeightScale()/1080), (Bullet.HEIGHT_SCALE* BossMap.getHitboxHeightScale()/1080), 3, 10, direction, 0);
    }
